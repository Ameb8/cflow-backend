...
def map_asm(asm_dbg_path, asm_pure_path):
    ...
    Returns:
        dict: A dictionary mapping C line numbers to assembly line numbers
              Entries: (C line number, Pure ASM line number)
    """
...
def test_map_asm():
    asm_pure_path = '/Users/pattycrowder/cflow_test/asm_1.s'
    asm_dbg_path = '/Users/pattycrowder/cflow_test/main_1.s'
