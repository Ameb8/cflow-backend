...
from .views import FolderViewSet, FileViewSet, get_file_tree, get_user_filesystem, get_user_project, build_folder, apply_file_changes
...
urlpatterns = [
    ...
    path('filesystem/<int:folder_id>/', get_file_tree, name='get_user_project'),
